...
from pytest_testrailv2 import plugin
from pytest_testrailv2.plugin import TESTRAIL_TEST_STATUS, PyTestRailPlugin
from pytest_testrailv2.testrail_api import APIClient
...
PROJECT_ID = 4
PYTEST_FILE = """
    from pytest_testrailv2.plugin import testrail, pytestrail
